...
- **Generated/<config>/html:** The primary output directory of the project. It contains created package archives in the :code:`Downloads` subdirectory.
...
- **Generated/<config>/_pckg:** A directory that is used to accumulate the contents of the created package archives.
  If everything goes well, the contents are only of interest when developing the CPFCMake package itself.
